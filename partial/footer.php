    ...
    <div class="container">
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                ...
                <p class="mb-[5px] xl:mb-[40px] max-w-[270px]">Sharify est un site d’annonces immobilières international alimenté par des annonces de particuliers et de professionnels de l’immobilier.</p>
                <p class="text-sm hidden md:block">&copy; <a href="https://themeforest.net/user/codecarnival/portfolio" class="text-secondary">Sharify.</a> Tous droits réservés</p>
            </div>
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
                <h3 class="font-lora font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                    Liens rapides<span class="text-secondary">.</span></h3>
                <ul class="text-[16px] leading-none mb-[-20px]">
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="categorie.php?categorie=1">A Louer</a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="categorie.php?categorie=2">A vendre</a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="properties.php">Propriétes</a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Qui sommes nous</a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Actus et conseils
                            </a></li>
                </ul>
            </div>
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
                <h3 class="font-lora font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                    Contactez nous<span class="text-secondary">.</span></h3>
                <ul class="text-[16px] leading-none mb-[-20px]">
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary"href="tel:94 43 94 94">Afrique: (+229) 94 43 94 94</a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="tel:0661180648">Europe: (+33) 0661180648</a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="mailto:contact@Sharify.com">contact@Sharify.com</a>
                    </li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="index.php">Sharify</a></li>
                </ul>
            </div>
            <div class="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                ...
                <ul class="inline-flex items-center justify-center mt-[20px]">
                    <li class="first:ml-0 ml-[15px]">
                        <a href="https://www.facebook.com/" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                    ...
                    <li class="ml-[15px]">
                        <a href="https://twitter.com/" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                    ...
                    <li class="ml-[15px]">
                        <a href="https://www.instagram.com/" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                ...
                <p class="text-sm md:hidden mt-[20px]">&copy; <a href="https://themeforest.net/user/codecarnival/portfolio" class="text-secondary">CodeCarnival.</a> All Rights Reserved - Privacy Policy</p>
            </div>
        </div>
    </div>
</footer>