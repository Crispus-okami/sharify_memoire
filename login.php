...
<body class="font-karla text-body text-tiny">
    <div class="overflow-x-hidden">
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                            ...
                            Retrouvez les meilleures opportunités immobilières partout dans le monde. 
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="py-[80px] lg:py-[120px]">
            <div class="container">
                <form method="POST" action="app/lib/process.php?process=login">
                    <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                        <div class="col-span-12 lg:col-span-6 mb-[30px]">
                            <h2 class="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[15px] font-medium">
                                Connexion<span class="text-secondary">.</span></h2>
                           ...
                           <!--  <p class="max-w-[465px] mb-[50px]">
                            ...
                            <div class="grid grid-cols-12 gap-x-[20px] gap-y-[35px]">
                                ...
                                <div class="col-span-12">
                                    <input name="username" class="font-light w-full sm:w-[400px] leading-[1.75] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-[#FD6400] focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] " type="text" placeholder="Nom d'utilisateur ou Email">
                                </div>
                                ...
                                <div class="col-span-12">
                                    ...
                                    <div class="flex flex-wrap items-center justify-between w-full sm:w-[400px] mt-[15px]">
                                        <div class="flex flex-wrap items-center">
                                            ...
                                            <label for="checkbox1" class="ml-[5px] cursor-pointer text-[14px]"> Se
                                                rapeller de moi</label><br>
                                        </div>
                                        <a href="#" class="hover:text-secondary text-[14px] block">Mot de passe oublié</a>
                                    </div>
                                </div>
