...
<body class="font-karla text-body text-tiny">
                                        ...
                                        <div class="slider-content">
                                            <div class="relative mb-5 sub_title">
                                                ...
                                                <span class="bg-[#FFF6F0] text-base text-secondary block absolute left-[28px] top-1/2 -translate-y-1/2">
                                                    ...
                                                    PASSEZ VOS ANNONCES GRATUITEMENT SUR
                                            ...
                                            <h1 class="font-lora text-primary text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl title font-medium">
                                                ...
                                                <span>Sharify, L'immobilier plus proche de vous !</span>
                                            ...
                                            <?php
                                                 ...
                                                 $a = $model->countAll('annonce', '*');
                                            ?>
                                            <p class="text-base text-[#494949] mt-5 mb-8 text max-w-[570px]">
                                                Retrouvez plus de <?php echo $a ?> opportunités
                                                immobilières partout dans le monde. </p>
                                            ...
                                            <!--                                             <span class="block font-lora hero_info"><span class="text-[20px] sm:text-[22px] text-secondary">Have a question?</span> <a href="tel:9985254784" class="text-[22px] sm:text-[32px] text-primary hover:underline font-semibold ml-2">+0123456789</a></span>
 -->
                                        </div>
                                    </div>
                            ...
                            <form action="#">
                                <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                        ...
                                        <div class="flex-1">
                                            <label for="location" class="font-lora block capitalize text-primary text-[17px] xl:text-[24px] leading-none mb-1">Pays</label>
                                            <select id="location" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                                <?php
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                        ...
                                        <div class="flex-1">
                                            <label for="property" class="font-lora block capitalize text-primary text-[17px] xl:text-[24px] leading-none mb-1">Categorie
                                            </label>
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                        ...
                                        <div class="flex-1">
                                            <label for="town" class="font-lora block capitalize text-primary text-[17px] xl:text-[24px] leading-none mb-1">Villes</label>
                                            <select id="town" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                                <?php
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] relative">
                                        ...
                                        <div class="flex-1">
                                            <label for="town" class="font-lora block capitalize text-primary text-[17px] xl:text-[24px] leading-none mb-1">Régions</label>
                                            <select id="town" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                                <?php

                                                $payload = $model->read('voisinage', '*');
                                                while ($area = $payload->fetch()) {

                                                    echo ('

                                    <option value="' . $area['id'] . '">' . $area['nom'] . '</option>
        ...
        <section class="popular-properties py-[80px] lg:py-[120px]">
            <div class="container">
                <div class="grid grid-cols-12">
                    <div class="col-span-12"> <span class="text-secondary text-tiny inline-block mb-2">A la une</span></div>
                    <div class="col-span-12">
                        <div class="flex flex-col sm:flex-row items-start justify-between mb-[50px]">
                            <div>
                                ...
                                Découvrez nos annonce à la une
                                    <span class="text-secondary">.</span>
                                </h2>
                            </div>
                            <div>
                                <!-- <a href="properties-v1.html" class="flex flex-wrap items-center text-secondary text-tiny">Tout voir
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                    ...
                    $payload = $model->read('annonce', '*', 3, 'id', 'true');
        ...
        <section class="popular-properties py-[80px] lg:py-[120px]">
            <div class="container">
                <div class="grid grid-cols-12">
                    <div class="col-span-12"> <span class="text-secondary text-tiny inline-block mb-2">Récemments ajoutés</span></div>
                    <div class="col-span-12">
                        <div class="flex flex-col sm:flex-row items-start justify-between mb-[50px]">
                            <div>
                            ...
                            <div>
                                <a href="all.php" class="flex flex-wrap items-center text-secondary text-tiny">Tout voir
                                    <svg class="ml-[10px]" width="26" height="11" viewBox="0 0 26 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20.0877 0.69303L24.2075 5.00849H0V5.99151H24.2075L20.0877 10.307L20.7493 11L26 5.5L20.7493 0L20.0877 0.69303Z" fill="currentColor" />
                                    </svg>
                                </a>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                    ...
                    $payload = $model->read('annonce', '*', 6, 'id', 'true');
      ...
      <!--   <section class="about-section">
            <div class="container">
                <div class="grid grid-cols-12">
                    ...
                    <div class="col-span-12 lg:col-span-5">
                        ...
                        <h2 class="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl capitalize mb-3 font-medium">
                            We
                ...
                <div class="grid grid-cols-12 gap-[30px] items-center">
                    <div class="col-span-12 lg:col-span-6 relative">
                        <div class="mb-5 lg:mb-0 max-w-[450px]">
                            ...
                            <h2 class="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[10px] font-medium">Watch the video for taking your decision easily<span class="text-secondary">.</span></h2>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency.html" class="block">
                                                ...
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-lora font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">New York</span>
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency.html" class="block">
                                                ...
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-lora font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Sun Francisco</span>
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency.html" class="block">
                                                ...
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-lora font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Washington D.C.</span>
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency.html" class="block">
                                                ...
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-lora font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Francisco</span>
       ...
       <!--  <section class="testimonial-section md:pt-[50px] bg-no-repeat bg-white relative z-[5]" style="background-image: url(assets/images/testimonial/pattern.png);">
                ...
                <div class="grid items-center grid-cols-12 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="col-span-12 lg:col-span-5 mb-[30px] order-first lg:order-last">
                        <div class="relative 2xl:ml-[55px] max-w-[385px]">
                            ...
                            <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl mb-[20px] max-w-[375px] font-medium">
                                Reviews from
                                our
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="mb-[30px] lg:mb-[60px] text-center">
                            ...
                            <h2 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium">Here
                                is our
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="text-center group mb-[30px]">
                        ...
                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-lora font-normal text-base text-primary group-hover:text-white">Albert S. Smith</a></h3>
                            ...
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]">
                                ...
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-500 delay-300 ml-[15px]">
                                    <a href="#" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                ...
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-700 delay-300 ml-[15px]">
                                    <a href="#" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                    ...
                    <div class="text-center group mb-[30px]">
                        ...
                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-lora font-normal text-base text-primary group-hover:text-white">Amelia Margaret</a></h3>
                    ...
                    <div class="text-center group mb-[30px]">
                        ...
                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-lora font-normal text-base text-primary group-hover:text-white">Stephen Kelvin</a></h3>
                            <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-white">Real Estate Agent</p>
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]">
                                    <a href="#" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                    ...
                    <div class="text-center group mb-[30px]">
                        ...
                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-lora font-normal text-base text-primary group-hover:text-white"> Michael Richard</a></h3>
                            <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-white">Real Estate Broker</p>
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]">
                                    <a href="#" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
 ...
 -->
        ...
        <!-- News Letter section start -->
                    <?php require('partial/newsletter.php')?>
