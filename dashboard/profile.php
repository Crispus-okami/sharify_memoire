            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    ...
                    <section class="content">
                        <h3>Bienvenue : </h3>
                        <form action="../app/lib/process.php?process=upProf&id=<?php echo $id ?>" enctype="multipart/form-data" method="POST">
                        <div class="row">
                                ...
                                <?php
                                $model = new model();
                                $payload = $model->read_filter_once('agence', '*', 'compte', $id);
                                $agence = $payload->fetch()
                                ?>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Nom de l'agence</label>
                                    <input type="text" name="name" value="<?php echo $agence['nom'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Telephone</label>
                                    <input type="text" name="tel" value="<?php echo $agence['telephone'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Email</label>
                                    <input type="email" name="mail" value="<?php echo $agence['email'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Mobile</label>
                                    <input type="text" name="mob" value="<?php echo $agence['mobile'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Skype</label>
                                    <input type="text" name="skype" value="<?php echo $agence['skype'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Langues</label>
                                    <input type="text" name="lg" value="<?php echo $agence['langue'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>SIREN/IFU</label>
                                    <input type="text" name="ifu" value="<?php echo $agence['siren'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>SIRET/RCCM</label>
                                    <input type="text" name="rccm" value="<?php echo $agence['siret'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Heures d'ouverture</label>
                                    <input type="text" name="hr" value="<?php echo $agence['horaire'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>HubSpot Api Key</label>
                                    <input type="text" name="api" value="<?php echo$agence['hubspot'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Facebook URL</label>
                                    <input type="text" name="fb" value="<?php echo $agence['facebook'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Instagram URL</label>
                                    <input type="text" name="insta" value="<?php echo $agence['insta'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Twitter URL</label>
                                    <input type="text" name="twi" value="<?php echo $agence['twitter'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Pinterest URL</label>
                                    <input type="text" name="pin" value="<?php echo $agence['pinterest'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>LinkedIn URL</label>
                                    <input type="text" name="lkd" value="<?php echo $agence['linkedin'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Lien Site Web (Sans HTTP) </label>
                                    <input type="text" name="web" value="<?php echo $agence['web'] ?>" class="form-control">
                                </div>

                                <!-- <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Categorie</label>
                                    <select type="text" name="cat" value="<?php echo $agence['categorie'] ?>" class="form-control">
                                        <option>Aucun</option>
                                    </select>
                                </div> -->
                                ...
                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Ville</label>
                                    <input type="text" name="ville" value="<?php echo $agence['ville'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Pays</label>
                                    <input type="text" name="pays" value="<?php echo $agence['pays'] ?>" class="form-control">
                                </div>

                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Zone</label>
                                    <input type="text" name="zone" value="<?php echo $agence['zone'] ?>" class="form-control">
                                </div>


                                <div class="col-6 col-lg-6 col-md-6 col-sm-12">
                                    <label>Adresse</label>
                                    <input type="text"value="<?php echo $agence['adresse'] ?>" class="form-control" name="addr">
                                </div>
                                    <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                                        <label>A propos</label>
                                        <textarea type="text" name="about" value="<?php echo $agence['about'] ?>" class="form-control"></textarea>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-12 col-md-12 col-sm-12" style="padding-top: 15px">
                                        <input type="submit" value="Mettre à jour le profil" class="form-control">
                                    </div>
