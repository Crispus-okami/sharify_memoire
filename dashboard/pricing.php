				...
				<div class="content-header">
					...
					<section class="content">
						<?php
                                ...
                                $payload = $model->read("plan_abonnement", '*');
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header with-border">
										<h4 class="box-title">Autres Formules disponibles</h4>
										...
										<div class="table-responsive">
											...
											<table id="example" class="table table-lg invoice-archive">
												<thead>
													<tr>
														<th>Formule</th>
														<th>Nombre de jour offert</th>
														<th>Nombre d'annonce offert</th>
														<th>Prix</th>
												...
												<tbody>
													...
													while ($plan = $payload->fetch()) {
                                                        ...
                                                        if($plan['id']==1){}
                                                            ...
                                                            <tr>
                                                        <td>' . $plan['nom'] . '</td>
                                                        <td>' . $plan['nombre_jour'] . ' jours</td>
                                                        <td>' . $plan['nb_annonce'] . ' annonces</td>
                                                        <td>
                                                            <h6 class="mb-0">
                                                            ' . $plan['prix'] . ' €
                                                        ...
                                                        <div class="list-icons d-inline-flex">
                                                                ...
                                                                <a href="#" ><i class="mdi mdi-plus"></i> Activer cette formule</a>
