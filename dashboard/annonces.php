...
<body class="hold-transition light-skin sidebar-mini theme-blackberry">
	<div class="wrapper">
		...
		$model = new model();
		$payload = $model->read_filter_once('annonce', '*', 'compte_agence', $_SESSION['id']);
		...
		if (isset($_GET['valid'])){
			...
			$valid = $_GET['valid'];
			$ag = $_GET['u'];
			$query = "UPDATE annonce set active='$valid' WHERE slug='$ag'";
			$db->query($query);
			...
			<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h3 class="page-title">Liste des annonces </h3>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header with-border">
										<h4 class="box-title">Liste des annonces</h4>
									...
									<div class="box-body">
										<div class="table-responsive">
											...
											<table id="example" class="table table-lg invoice-archive">
												...
												<tbody>
													...
													while ($annonce = $payload->fetch()) {
														...
														$load = $model->read_filter_once('categorie', '*', 'id', $annonce['categorie_annonce']);
														$cat= $load->fetch();
														echo ('
											...
											<td>' . $annonce['titre'] .'</td>
											<td>' . $cat['nom'] . '</td>
                                            <td>' . status_printer($annonce['valid']) . '</td>
											<td>
												<h6 class="mb-0">
												' . $annonce['prix'] . '
											...
											<div class="list-icons d-inline-flex">
													...
													' . ($annonce['active'] == 0 ? "<a href=\"annonces.php?valid=1&u=" . $annonce['slug'] . "\" class=\"dropdown-item\"><i class=\"mdi mdi-account-check\"></i>Activer</a>" : "<a href=\"annonces.php?valid=0&u=" . $annonce['slug'] . "\" class=\"dropdown-item\"><i class=\"mdi mdi-account-minus\"></i>Désactiver</a>") . '
